# -*- coding: UTF-8 -*-
import sys
#sys.path.append('/Users/my-mac/Documents/GitHub/selfteaching-python-camp/exercises/1901090043/d07/mymodule')
from stats_word import stats_text_en
import stats_word
...
47  Filled with admiration for Yugong, the Emperor of Heavens ordered
    ...
    '''
sort_txt = stats_text_en(txt)
#print(dir(stats_word))
path_txt = sys.path[0] + '/mytest.tst.py'
print(path_txt)
print('path' in sys.builtin_module_names)
#help(stats_word.stats_text_en)
#print(stats_text_en.__name__)
#print(sort_txt)